# TOTOLINK A3002RU boa formIpQoS Stack Overflow
...
The `formIpQoS` request is as follows: When `action` is `sqosadvAdd`, after receiving `mac`, it directly uses `strcpy`, causing a stack overflow vulnerability.
