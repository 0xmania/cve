# TOTOLINK A3002RUV3.0 boa formMapDelDevice Stack Overflow
...
The `formMapDelDevice` request is as follows: After receiving `hostname`, it directly uses `strcpy`, causing a stack overflow vulnerability.
